...
namespace trackpi.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(IDeviceRepository repo, DeviceViewModel vm, IHttpContextAccessor haccess)
        {
            _repo = repo;
            _viewModel = vm;
        ...
        public IActionResult Dev(int id)
        {
            HttpContext.Session.SetInt32("devId", id);
